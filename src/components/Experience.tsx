    ...
    <>
      ...
      >
        ...
        <div>
              ...
              <li key={index} className="mb-12">
                <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="z-10 sm:col-span-6">
                    ...
                    <p className="mt-2 text-sm leading-normal text-justify">{job.description}</p>
          ...
          <div className="mt-12">
            <a
              className="inline-flex items-center font-medium leading-tight text-primary font-semibold text-primary group hover-accent"
